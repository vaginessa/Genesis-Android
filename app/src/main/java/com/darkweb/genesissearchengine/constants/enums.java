...
public class enums
{
    ...
    public enum eventType{welcome,cancel_welcome,reload, clear_history,bookmark, app_rated,download_file, update_searcn, update_javascript, update_history,close_view}
